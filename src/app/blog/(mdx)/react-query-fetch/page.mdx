...
<BlogHeader slug="react-query-fetch" />

<br />

Data fetching is the most crucial part of any web application. This is the showcase of how I like to do data fetching in React codebase. I am a big fan of [Tanstack Query](https://tanstack.com/query) library. It is a powerful and easy to use library for data fetching.
            ...
            ...(filterMap?.size > 0
              ? {
                  filter: JSON.stringify(
                    Object.fromEntries(filterMap.entries())
                  ),
                }
              : {}),
...
You can find example usage in this [Stackblitz Example](https://stackblitz.com/edit/nisargbhatt-tanstack-query-example?file=README.md)
